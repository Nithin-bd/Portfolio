...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_pevk7oy", "template_5tgf9f5", formRef.current, {
        publicKey: "FwCJ6Y5aywYTvOFwm",
      })
      .then(
        () => {
          setSuccess(true);
  ...
  return (
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        <motion.h1 variants={variants}>Looking for some help?</motion.h1>
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>dsanithin@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Location</h2>
